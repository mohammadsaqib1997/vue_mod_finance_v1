...
router.post('/pdf/bal_sheet/control', function (req, res, next) {

    res.render('download_templates/bs_control', req.body, function (errJade, html) {
        if (errJade) {
...
router.post('/html/bal_sheet/control', function (req, res, next) {
...
router.post('/csv/bal_sheet/control', function (req, res, next) {
