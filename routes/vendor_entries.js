...
router.post('/pdf/vendor_entries', function (req, res, next) {

    res.render('download_templates/vendor_entries', req.body, function (errJade, html) {
        if (errJade) {
...
router.post('/html/vendor_entries', function (req, res, next) {
