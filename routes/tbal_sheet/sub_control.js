...
router.post('/pdf/tbal_sheet/sub_control', function (req, res, next) {
...
router.post('/html/tbal_sheet/sub_control', function (req, res, next) {
...
router.post('/csv/tbal_sheet/sub_control', function (req, res, next) {
