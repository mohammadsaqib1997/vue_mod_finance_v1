...
router.post('/pdf/tbal_sheet/subsidiary', function (req, res, next) {
...
router.post('/html/tbal_sheet/subsidiary', function (req, res, next) {
...
router.post('/csv/tbal_sheet/subsidiary', function (req, res, next) {
